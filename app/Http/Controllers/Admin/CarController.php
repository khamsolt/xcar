...
class CarController extends Controller
{
    ...
    public function __construct(CarCrudService $carCrudService, ModelCrudService $modelCrudService)
    {
    ...
    public function store(Create $createRequest): RedirectResponse
    {
        ...
        try {
            $this->carCrudService->create($data);
    ...
    public function update(UpdateRequest $updateRequest, IDRequest $idRequest): RedirectResponse
    {
        ...
        try {
            ...
            return redirect(route('admin.car.edit', ['car' => $idRequest->id]))->withInput($data);
        }
